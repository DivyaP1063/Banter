    ...
    <div className="h-full w-[6%] rounded-2xl bg-violet-700 shadow-md shadow-purple-800 flex flex-col justify-between items-center py-4">
      <div className="flex flex-col items-center gap-y-4">
        <div className="rounded-full w-[50px] h-[50px] ">
          <img
            ...
            className="rounded-full object-cover w-[50px] h-[50px] hover:scale-110 transition-transform duration-150 ease-in-out"
          ></img>
        </div>
      ...
      <div className="hover:scale-110 transition-transform duration-150 ease-in-out">
        <button onClick={logout}>
          <RiLogoutBoxLine fontSize="40px" color="white" />
        </button>
      </div>
    </div>
  );
